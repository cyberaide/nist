...
The NIST Big Data Working group has identified 51 benchmarking
examples for Big Data. In addition we reviewed 81 other usecases form
classes thought at Indiana University in the topic of Big Data. The
NIST examples 
include a selected set spawning application areas such as:
...
From these examples we have analyzed six of them in more detail (see
Table \ref{T:usecases}). 
