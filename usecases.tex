...
Apache Spark \cite{??}, 
\TODO{Hyungro: make reference out of: Ansible Role for Spark:
  https://github.com/VirtualClusters/ansible-role-spark-for-mesos}
Apache Mesos \cite{??},
Apache Zookeeper \cite{??},
\TODO{Hyungro: make reference out of: Ansible Role for Mesos (with Zookeeper):
  https://github.com/VirtualClusters/ansible-role-mesos-by-mesosphere}
OpenCV (with Python) \cite{??}
\TODO{Hyungro: make reference out of: Ansible Role for OpenCV:
