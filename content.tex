...
\begin{center}
\begin{tabular}{|p{7cm}|p{1.55cm}|p{7cm}|}
\hline
\blue \textbf{URL} & \blue \textbf{REST Method} & \blue \textbf{Description}\tabularnewline
...
/:id/delete                     & DELETE   & Delete a composition \tabularnewline \hline
...
/:id/delete                & DELETE & deletes the experiment with the given id \tabularnewline \hline
