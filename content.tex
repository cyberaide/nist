...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Virtual cluster
\hline \multicolumn{2}{|l|}{\grey\bf Virtual Cluster: /cluster} \tabularnewline \hline
/                       & List available clusters \tabularnewline \hline
/create                 & Launch a cluster on the provider \tabularnewline \hline
/:id/delete             & Delete and destroy a cluster \tabularnewline \hline
/:id                    & View the status of a cluster (nodes, node type, etc) \tabularnewline \hline
/:id/property/:property & Get/set a property (provider, name, description) of the cluster \tabularnewline \hline
/:id/inventory/:format  & Obtain an inventory of the cluster \tabularnewline \hline

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Composition
\hline \multicolumn{2}{|l|}{\grey\bf Stack Composition: /stack} \tabularnewline \hline
/                               & List available compositions \tabularnewline \hline
/create                         & Create a new composition \tabularnewline \hline
/:id                            & Show information about the composition \tabularnewline \hline
/:id/name                       & Get/set the name of the composition \tabularnewline \hline
/:id/add?deployer=<>\&source=<> & Add a layer to the composition \tabularnewline \hline
/:id/layer                      & List layers of the composition \tabularnewline \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Stack Deployment
\hline \multicolumn{2}{|l|}{\grey\bf Stack Deployment: /stack} \tabularnewline \hline
/                    & List the available stacks with discription \tabularnewline \hline
/:id/deploy/:cluster & Deploy a stack onto a cluster \tabularnewline \hline
/:id/status          & Get current status \tabularnewline \hline

 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Batch
\hline \multicolumn{2}{|l|}{\grey\bf Batch Experiments: /hpc} \tabularnewline \hline
/                                            & list all jobs started with the run command \tabularnewline \hline
/run?script=<scriptname>\&cluster=<clustername> & submits an experiment to the named cluster \tabularnewline \hline
/:id/status                                     & returns the status of the job started with the run command \tabularnewline \hline
