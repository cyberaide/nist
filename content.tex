...
\caption{This shows how stacks may be composed. The \texttt{web} stack
  is a composition of the \texttt{mysql} and \texttt{nginx}
  stacks. \texttt{web} is then included as a layer withing another
  composition which includes \texttt{hadoop} and \texttt{spark}
  compositions.}
\end{figure}
\TODO{Gregor,
